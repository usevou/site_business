<?php
  ...
  if ( isset($_POST['q']) ){
    ...
    if ( !validaemail($email) ){
      ...
      $envio = mail("jefferson@usevou.com", "Formulário do site empresário: ".$assunto, "Nome: ".$nome."\nE-mail: ".$email."\n\n".$msg, $headers);
      ...
      if($envio){
        ...
        $envio = mail("gustavo@usevou.com", "Formulário do site empresário: ".$assunto, "Nome: ".$nome."\nE-mail: ".$email."\n\n".$msg, $headers);
